...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-01-2025 a las 20:21:05
...
(1, '11111111A', 'Fernando Beni'),
(2, '22222222B', 'Angel López Moreno'),
(3, '33333333C', 'Juande Jefe'),
(4, '44444444D', 'Aaser JR 7');
...
(1, 'Desarrollo web en en', 'DAW', 2),
(2, 'Desarrollo web en en', 'DAM', 2),
(3, 'Despliegue de aplica', 'DAW', 1),
(4, 'Empresa e iniciativa', 'DAM', 1);
